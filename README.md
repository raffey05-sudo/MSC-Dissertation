...
The objective of this research was to develop and validate a probabilistic 3D Gaussian Mixture Model (GaussCluster) to kinetically isolate open clusters in heavily obscured environments, specifically targeting the complex Cygnus X star-forming region (Berkeley 87).
...
* **Writeup/**: Contains the complete LaTeX source code (.tex files) for the dissertation manuscript, including all chapters and appendices.
